...
var tB = (Func<string, string, string, bool, Tuple<string, string, string, bool>>) ((elmt1, elmt2, elmt3, elmt4) => { return Tuple.Create(elmt1, elmt2, elmt3, elmt4); });
    ...
    tB("crash", "CP_Crash_Marta", "God, Do You Want Him?", false),
    ...
    tB("chapel", "CP_VS2_Chapel_2", "Inside the Chapel", false),
    ...
    tB("roadmine", "CP_VS3_Watermill_1", "Leaving the Cornfield", false),
    tB("roadmine", "CP_VS3_Watermill_2", "Grabbing the Crank", true),
    tB("roadmine", "CP_VS3_MartaField", "Leaving the Watermill", false),
    tB("roadmine", "CP_VS3_MartaField_2", "Marta Doesn't Quit", false),
    tB("roadmine", "CP_VS3_Hook", "Grabbed the Hook", true),
    tB("roadmine", "CP_VS3_Hook_2", "Marta Breaks through the Gate", false),
    tB("roadmine", "CP_VS3_MartaShowdown", "After Placing Hook", false),
    ...
    tB("supper", "CP_SY_MineFacilityShot", "Before the Rope Fetch Quest", true),
    ...
    tB("raft", "CP_RV_TopStairs", "Climbing the Hill", false),
    ...
    tB("val", "CP_MU_ClimbinglFiesta", "Climb the Ladders", false),
    tB("val", "CP_MU_ClimbinglFiestaDone", "Climbed the Ladders", false),
    ...
    tB("apocalypse", "CP_BF_Cemetary", "The Baby is Coming Soon", false),
    tB("apocalypse", "CP_BF_Chapel", "Before the Birth", false),
    tB("apocalypse", "CP_School_TightQuarter", "Jessica and Blake", false),
